...
public static class PoolExtensions {
	...
	public static Entity spawnPlayer(this Pool pool, int player_ID, Vector3 pos, bool bControllable=false){
    var rPlayer = pool.CreateEntity()
      .AddPlayer(player_ID)
    ...
    if(bControllable==true){
      rPlayer.AddIO_Controllable(player_ID);  // systemReact will add state for dpad and button, as well as inputcontroller gets
    }
    return rPlayer;
	}
